...
def _concat_dataset(cfg, default_args=None):
    ...
    density_prefixes = cfg.get('density_prefix', None)
    center_prefixes = cfg.get('center_prefix', None)
    ...
    for i in range(num_dset):
        ...
        if isinstance(density_prefixes, (list, tuple)):
            data_cfg['density_prefix'] = density_prefixes[i]
        if isinstance(center_prefixes, (list, tuple)):
            data_cfg['center_prefix'] = center_prefixes[i]
