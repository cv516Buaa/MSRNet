...
class CustomDataset(Dataset):
    ...
    def __init__(self,
        ...
        if self.data_root is not None:
            ...
            if not (self.density_prefix is None or osp.isabs(self.density_prefix)):
                self.seg_prefix = osp.join(self.data_root, self.density_prefix)
            if not (self.center_prefix is None or osp.isabs(self.center_prefix)):
                self.seg_prefix = osp.join(self.data_root, self.center_prefix)
    ...
    def pre_pipeline(self, results):
        ...
        results['density_prefix'] = self.density_prefix
        results['center_prefix'] = self.center_prefix
