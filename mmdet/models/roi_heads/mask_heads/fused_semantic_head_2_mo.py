...
class FusedDensityHead(BaseModule):
    ...
    def __init__(self,
        ...
        self.conv_embedding=ConvModule(
                ...
                conv_cfg=self.conv_cfg,
                norm_cfg=self.norm_cfg)
        self.conv_embedding_mask=ConvModule(
                conv_out_channels,
                conv_out_channels,
                1,
              #  padding=1,
...
#                    norm_cfg=self.norm_cfg)
    ...
    def forward(self, feats):
        ...
        x0 = self.conv_embedding(x)
        x1 = self.conv_embedding_mask(x)
        #draw_feature_map(mask_pred)
        return mask_pred, x0, x1
